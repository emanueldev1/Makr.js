...
export const ButtonRender = ({ children, variant = "default" }: { children: string; variant?: "default" | "outline" }) => {
    ...
    configForm: (props: any, onChange: (key: string, value: any) => void) => (
        <div className="space-y-3">
            <div>
                ...
                <input className="mt-1 block w-full rounded border p-2 text-sm" value={props.children} onChange={(e) => onChange("children", e.target.value)} />
            </div>
            <div>
